...
export default function CoreStrength() {
  return (
    <div className="w-full mx-auto flex justify-center mt-36">
      <div className="absolute max-w-screen-xl lg:w-[1150px] md:w-[1150px] w-full lg:h-[500px] md:h-[500px] h-[160%] bg-gradient-to-r from-[#3187FC] to-[#0522E6] mt-10 flex justify-center items-center rounded-[70px]">
        <img className="absolute lg:left-2 md:left-2 lg:bottom-7 md:bottom-7 lg:-top-32 md:-top-0 -top-64 lg:w-auto md:w-auto w-full" src={cuate} alt="" />
      ...
      <img className="w-full mt-[20%]" src={bg_image} alt="" />
    </div>
  );
}
