...
export default function LatestNews() {
  return (
    <div className="bg-[#4BA1FF] lg:py-[60px] md:py-[60px] py-[30px] lg:rounded-ss-[30px] md:rounded-ss-[30px] rounded-ss-[15px] lg:rounded-ee-[30px] md:rounded-ee-[30px] rounded-ee-[15px] lg:my-0 md:my-0 my-5">
