...
export default function FlagCard({image,name}) {
  ...
  return (
    ...
    <div className="lg:rounded-2xl md:rounded-2xl rounded-xl shadow-sm lg:w-[270px] md:w-[270px] w-[150px] lg:h-[350px] md:h-[350px] h-[190px] group-hover:-rotate-[11deg] origin-bottom after:duration-300 before:duration-300 duration-300 group-hover:duration-300 bg-cover" style={{ backgroundImage: `url(${image})` }}>

      <div className="lg:w-[270px] md:w-[270px] w-[150px] lg:h-[350px] md:h-[350px] h-[200px] overflow-hidden after:duration-300 before:duration-300  duration-300 group-hover:duration-300 absolute group-hover:rotate-[17deg] flex justify-center items-center origin-bottom  bg-[#081831] lg:rounded-[32px] md:rounded-[32px] rounded-[12px] group-hover:-ml-2 group-hover:mt-20 ">
